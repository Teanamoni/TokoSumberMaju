...
class AboutSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // TAMBAHKAN DATA DEFAULT BARU DI SINI:
        $about->hero_bg = 'default_hero.jpg';
        $about->whatsapp = '6281226271820';
        $about->jam_operasional = "Senin - Sabtu: 07.00 - 17.00\nMinggu: 08.00 - 14.00";
        $about->alamat = 'Jl. Brotojoyo Bar. II No.4, Panggung Kidul, Semarang Utara, Kota Semarang, Jawa Tengah 50178';
        $about->footer_text = '© 2010 - 2024 Toko Sumber Maju. Hak Cipta Dilindungi.';
